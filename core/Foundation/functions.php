...
if (!function_exists('url')) {
     ...
     */
    function url($path = '') {
        $baseUrl = JThink::$config['base_url'] ?? '';
...
if (!function_exists('validate')) {
    ...
    function validate($data, $rules, $messages = []) {
        return \JThink\Core\Support\Validator::make($data, $rules, $messages);
    }
}
...
if (!function_exists('jwt')) {
    /** 获取 JWT 工具类 */
    function jwt() {
        return \JThink\Core\Support\JWT::class;
    }
}
...
if (!function_exists('uploader')) {
    ...
    function uploader($config = []) {
        return new \JThink\Core\Support\Uploader($config);
    }
}
...
if (!function_exists('mailer')) {
    ...
    function mailer($config = []) {
        return new \JThink\Core\Support\Mailer($config);
    }
}
...
if (!function_exists('queue')) {
    ...
    function queue() {
        ...
        return new \JThink\Core\Support\Queue($driver, $config);
    }
}
...
if (!function_exists('send_mail')) {
    ...
    function send_mail($to, $subject, $body, $isHtml = true) {
        return \JThink\Core\Support\Mailer::sendSimple($to, $subject, $body, $isHtml);
    }
}
...
if (!function_exists('request')) {
    ...
    function request($key = null, $default = null) {
        $request = JThink::container()->make('request');
...
if (!function_exists('response')) {
    ...
    function response($content = '', $status = 200, $headers = []) {
        return JThink::container()->make('response', [$content, $status, $headers]);
    }
}