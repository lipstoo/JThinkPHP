...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .message { color: var(--text-secondary); font-size: 16px; word-break: break-all; }
        ...
        .trace-title::after { content: ''; flex: 1; height: 1px; background: var(--border); margin-left: 15px; }
        ...
        .jthink-logo { font-weight: 700; color: #3b82f6; }
    </style>
</head>
<body>
    <div class="error-container">
        ...
        <div class="content">
            <div class="trace-title">Stack Trace / Details</div>
            <div class="trace-box">{$message}</div>
        </div>

        <div class="footer">
            <span>Powered by <span class="jthink-logo">JThinkPHP</span> Framework</span>
